...
import { defaultImg } from '../../config/base'

import { FoodsPage, FoodsClass } from '../../api/interface'
...
interface CategoriesProps {
  ...
  activeFoodPage
  onfoodPage: (item) => void
  onSetFoodsPage: (list, item) => void
  onFilterClear: () => void
  onRemoveOffset: () => void
}
